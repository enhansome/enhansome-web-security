...
For [Codex](https://github.com/openai/codex) ⭐ 106,584 | 🐛 12,919 | 🌐 Rust | 📅 2026-08-18, swap `-a claude-code` → `-a codex`.
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [AwesomeXSS](https://github.com/s0md3v/AwesomeXSS) ⭐ 5,136 | 🐛 1 | 🌐 JavaScript | 📅 2024-10-30 - Written by [@s0md3v](https://github.com/s0md3v).
...
* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).

<a name="sql-injection"></a>

### SQL Injection

* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,680 | 🐛 670 | 🌐 Ruby | 📅 2026-08-18 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSRF%20Injection) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 80,131 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [Altus iX Developer XAML Deserialization RCE](https://0day-rubbish.com/blog/altus-ix-developer-xaml-rce) - Root-cause analysis and reproducible PoC for a XAML deserialization RCE (CVSS 7.3) in a SCADA HMI engineering IDE, including affected versions and a self-contained exploit script, published by [0day Rubbish](https://github.com/Exploit-Garbage/0day-Rubbish) ⭐ 162 | 🐛 0 | 🌐 Python | 📅 2026-08-18.
...
* [awesome-cve-poc](https://github.com/qazbnm456/awesome-cve-poc) ⭐ 3,523 | 🐛 2 | 📅 2022-01-04 - Curated list of CVE PoCs by [@qazbnm456](https://github.com/qazbnm456).
...
* [Capture the Flag CheatSheet](https://github.com/uppusaikiran/awesome-ctf-cheatsheet) ⭐ 139 | 🐛 0 | 📅 2025-04-29 - Written by [@uppusaikiran](https://github.com/uppusaikiran).
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 14,612 | 🐛 271 | 🌐 Python | 📅 2026-08-18 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,817 | 🐛 5 | 🌐 Python | 📅 2026-08-18 - Automated All-in-One OS command injection and exploitation tool by [@commixproject](https://github.com/commixproject).
...
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,119 | 🐛 59 | 🌐 Python | 📅 2026-08-07 - Incredibly fast crawler designed for OSINT by [@s0md3v](https://github.com/s0md3v).
...
* [Social Mapper](https://github.com/SpiderLabs/social_mapper) ⭐ 4,074 | 🐛 48 | 🌐 Python | 📅 2022-02-25 - Social Media Enumeration & Correlation Tool by Jacob Wilkin(Greenwolf) by [@SpiderLabs](https://github.com/SpiderLabs).
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 3,993 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning by [@evyatarmeged](https://github.com/evyatarmeged).
...
* [ReconDog](https://github.com/s0md3v/ReconDog) ⭐ 2,092 | 🐛 15 | 🌐 Python | 📅 2021-01-26 - Reconnaissance Swiss Army Knife by [@s0md3v](https://github.com/s0md3v).
...
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,023 | 🐛 253 | 🌐 Python | 📅 2024-08-02 - Sublist3r is a multi-threaded sub-domain enumeration tool for penetration testers by [@aboul3la](https://github.com/aboul3la).
...
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,556 | 🐛 116 | 🌐 Python | 📅 2026-01-21 - Web application bruteforcer by [@xmendez](https://github.com/xmendez).
* [fuzz.txt](https://github.com/Bo0oM/fuzz.txt) ⭐ 3,319 | 🐛 8 | 📅 2026-07-28 - Potentially dangerous files by [@Bo0oM](https://github.com/Bo0oM).
* [dirhunt](https://github.com/Nekmo/dirhunt) ⭐ 2,009 | 🐛 15 | 🌐 Python | 📅 2023-10-29 - Web crawler optimized for searching and analyzing the directory structure of a site by [@nekmo](https://github.com/Nekmo).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,577 | 🐛 104 | 🌐 Go | 📅 2026-08-17 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,731 | 🐛 0 | 🌐 Ruby | 📅 2026-07-23 - WPScan is a black box WordPress vulnerability scanner by [@wpscanteam](https://github.com/wpscanteam).
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,015 | 🐛 5 | 🌐 Go | 📅 2026-08-15 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision, maintained by [@j3ssie](https://github.com/j3ssie).
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,141 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - XSStrike is a program which can fuzz and bruteforce parameters for XSS. It can also detect and bypass WAFs by [@s0md3v](https://github.com/s0md3v).
* [beef](https://github.com/beefproject/beef) ⭐ 10,977 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-17 - The Browser Exploitation Framework Project by [beefproject](https://beefproject.com).
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,204 | 🐛 32 | 🌐 Python | 📅 2026-08-17 - Automatic SQL injection and database takeover tool.
...
* [XSRFProbe](https://github.com/0xInfection/XSRFProbe) ⭐ 1,302 | 🐛 0 | 🌐 Python | 📅 2026-07-12 - The Prime CSRF Audit & Exploitation Toolkit by [@0xInfection](https://github.com/0xinfection).
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 28,792 | 🐛 466 | 🌐 Go | 📅 2026-07-29 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
* [LinkFinder](https://github.com/GerbenJavado/LinkFinder) ⭐ 4,437 | 🐛 53 | 🌐 Python | 📅 2024-04-13 - Python script that finds endpoints in JavaScript files by [@GerbenJavado](https://github.com/GerbenJavado).
...
* [dvcs-ripper](https://github.com/kost/dvcs-ripper) ⭐ 1,781 | 🐛 11 | 🌐 Perl | 📅 2024-07-19 - Rip web accessible (distributed) version control systems: SVN/GIT/HG... by [@kost](https://github.com/kost).
* [keyFinder](https://github.com/momenbasel/keyFinder) ⭐ 697 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - Chrome extension that passively scans web pages for leaked API keys, tokens, and credentials across 10 attack surfaces using 80+ detection patterns and Shannon-entropy analysis, by [@momenbasel](https://github.com/momenbasel).
...
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,159 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-08 - Scanner detecting the use of JavaScript libraries with known vulnerabilities by [@RetireJS](https://github.com/RetireJS).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,311 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-16 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
...
* [UUSEC WAF](https://github.com/Safe3/uusec-waf/) ⭐ 1,703 | 🐛 83 | 🌐 Shell | 📅 2026-08-16 - An open-source web application firewall and API security gateway maintained by [UUCORP](https://github.com/Safe3/).
* [Acra](https://github.com/cossacklabs/acra) ⭐ 1,492 | 🐛 25 | 🌐 Go | 📅 2026-04-23 - Client-side encryption engine for SQL databases, with strong selective encryption, SQL injections prevention and intrusion detection by [@cossacklabs](https://www.cossacklabs.com/).
...
* [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 187 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-28 - Self-hosted CAPTCHA with behavioral analysis, vision-AI agent detection, headless-browser fingerprinting, and SHA-256 proof-of-work, maintained by [WebDecoy](https://github.com/WebDecoy).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,726 | 🐛 467 | 🌐 Python | 📅 2026-08-13 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).
...
* [PhpSploit](https://github.com/nil0x42/phpsploit) ⭐ 2,488 | 🐛 27 | 🌐 Python | 📅 2024-05-06 - Full-featured C2 framework which silently persists on webserver via evil PHP oneliner by [@nil0x42](https://github.com/nil0x42).
* [reverse-shell](https://github.com/lukechilds/reverse-shell) ⭐ 2,053 | 🐛 2 | 🌐 Go | 📅 2026-02-18 - Reverse Shell as a Service by [@lukechilds](https://github.com/lukechilds).
...
* [radare2](https://github.com/radare/radare2) ⭐ 24,588 | 🐛 820 | 🌐 C | 📅 2026-08-18 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
...
* [DNS Rebind Toolkit](https://github.com/brannondorsey/dns-rebind-toolkit) ⭐ 502 | 🐛 3 | 🌐 JavaScript | 📅 2021-10-02 - DNS Rebind Toolkit is a frontend JavaScript framework for developing DNS Rebinding exploits against vulnerable hosts and services on a local area network (LAN) by [@brannondorsey](https://github.com/brannondorsey).
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,607 | 🐛 564 | 🌐 JavaScript | 📅 2026-08-17 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,684 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-10 - Probably the most modern and sophisticated insecure web application - Written by [@bkimminich](https://github.com/bkimminich) and the [@owasp\_juiceshop](https://twitter.com/owasp_juiceshop) team.
...
* [OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 36 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-17 - Intentionally vulnerable e-commerce application built with Next.js - Written by [@kOaDT](https://github.com/kOaDT).
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,698 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool  - Written by [@RhinoSecurityLabs](https://github.com/RhinoSecurityLabs).
...
* [Infosec\_Reference](https://github.com/rmusser01/Infosec_Reference) ⭐ 5,985 | 🐛 3 | 🌐 CSS | 📅 2025-10-20 - Information Security Reference That Doesn't Suck by [@rmusser01](https://github.com/rmusser01).
* [awesome-bug-bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,857 | 🐛 30 | 📅 2026-03-07 - Comprehensive curated list of available Bug Bounty & Disclosure Programs and write-ups by [@djadmin](https://github.com/djadmin).
* [bug-bounty-reference](https://github.com/ngalongc/bug-bounty-reference) ⭐ 4,246 | 🐛 3 | 📅 2024-07-31 - List of bug bounty write-up that is categorized by the bug nature by [@ngalongc](https://github.com/ngalongc).
...
* [htb-writeups](https://github.com/momenbasel/htb-writeups) ⭐ 211 | 🐛 0 | 🌐 HTML | 📅 2026-07-18 - Comprehensive Hack The Box writeup collection covering 75+ web challenges including XSS, SQLi, SSTI, SSRF, and deserialization, by [@momenbasel](https://github.com/momenbasel).
