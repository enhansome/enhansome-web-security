...
For [Codex](https://github.com/openai/codex) ⭐ 125,914 | 🐛 18,258 | 🌐 Rust | 📅 2026-09-22, swap `-a claude-code` → `-a codex`.
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,750 | 🐛 735 | 🌐 Ruby | 📅 2026-09-22 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Cross-Site%20Request%20Forgery) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 81,083 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 14,847 | 🐛 385 | 🌐 Python | 📅 2026-09-22 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,854 | 🐛 3 | 🌐 Python | 📅 2026-09-22 - Automated All-in-One OS command injection and exploitation tool by [@commixproject](https://github.com/commixproject).
...
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,450 | 🐛 320 | 🌐 Python | 📅 2026-04-13 - Open source footprinting and intelligence-gathering tool by [@binarypool](https://twitter.com/binarypool).
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,222 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Incredibly fast crawler designed for OSINT by [@s0md3v](https://github.com/s0md3v).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,425 | 🐛 109 | 🌐 Go | 📅 2026-09-22 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,776 | 🐛 1 | 🌐 Ruby | 📅 2026-09-21 - WPScan is a black box WordPress vulnerability scanner by [@wpscanteam](https://github.com/wpscanteam).
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,080 | 🐛 4 | 🌐 Go | 📅 2026-09-22 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision, maintained by [@j3ssie](https://github.com/j3ssie).
...
* [beef](https://github.com/beefproject/beef) ⭐ 11,023 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-22 - The Browser Exploitation Framework Project by [beefproject](https://beefproject.com).
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,425 | 🐛 483 | 🌐 Go | 📅 2026-09-09 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
...
* [keyFinder](https://github.com/momenbasel/keyFinder) ⭐ 717 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - Chrome extension that passively scans web pages for leaked API keys, tokens, and credentials across 10 attack surfaces using 80+ detection patterns and Shannon-entropy analysis, by [@momenbasel](https://github.com/momenbasel).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,409 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-22 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
...
* [Pompelmi](https://github.com/pompelmi/pompelmi) ⭐ 678 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-23 - In-process file-upload security middleware for Node.js that scans untrusted uploads before storage to detect malware, MIME spoofing, and risky archives, maintained by [pompelmi](https://github.com/pompelmi).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,120 | 🐛 493 | 🌐 Python | 📅 2026-09-10 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,071 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 - Single-binary intercepting proxy for HTTP, HTTPS, and WebSocket traffic that pauses and edits requests in flight, replays them, rewrites traffic with Lua hooks, and exports captures as HAR, curl, or raw HTTP, available as a terminal UI, web GUI, or headless REST API, by [@emanuele-em](https://github.com/emanuele-em).
...
* [webshell](https://github.com/tennc/webshell) ⭐ 10,776 | 🐛 0 | 🌐 PHP | 📅 2024-12-24 - This is a webshell open source project by [@tennc](https://github.com/tennc).
* [Weevely](https://github.com/epinna/weevely3) ⭐ 3,534 | 🐛 17 | 🌐 Python | 📅 2025-10-01 - Weaponized web shell by [@epinna](https://github.com/epinna).
...
* [radare2](https://github.com/radare/radare2) ⭐ 24,850 | 🐛 822 | 🌐 C | 📅 2026-09-22 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,907 | 🐛 587 | 🌐 JavaScript | 📅 2026-09-21 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,919 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-22 - Probably the most modern and sophisticated insecure web application - Written by [@bkimminich](https://github.com/bkimminich) and the [@owasp\_juiceshop](https://twitter.com/owasp_juiceshop) team.
