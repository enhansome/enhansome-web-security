...
For [Codex](https://github.com/openai/codex) ⭐ 111,880 | 🐛 13,431 | 🌐 Rust | 📅 2026-08-22, swap `-a claude-code` → `-a codex`.
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).

<a name="sql-injection"></a>

### SQL Injection

* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,686 | 🐛 680 | 🌐 Ruby | 📅 2026-08-22 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSRF%20Injection) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 80,264 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [Practical introduction to SSL/TLS](https://github.com/Hakky54/mutual-tls-ssl) ⭐ 637 | 🐛 1 | 🌐 Java | 📅 2026-08-15 - Written by [@Hakky54](https://github.com/Hakky54).
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 14,645 | 🐛 276 | 🌐 Python | 📅 2026-08-21 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,821 | 🐛 4 | 🌐 Python | 📅 2026-08-21 - Automated All-in-One OS command injection and exploitation tool by [@commixproject](https://github.com/commixproject).
...
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,127 | 🐛 59 | 🌐 Python | 📅 2026-08-07 - Incredibly fast crawler designed for OSINT by [@s0md3v](https://github.com/s0md3v).
...
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 3,998 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning by [@evyatarmeged](https://github.com/evyatarmeged).
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,619 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - FOCA (Fingerprinting Organizations with Collected Archives) is a tool used mainly to find metadata and hidden information in the documents its scans by [ElevenPaths](https://www.elevenpaths.com/index.html).
...
* [fuzz.txt](https://github.com/Bo0oM/fuzz.txt) ⭐ 3,320 | 🐛 8 | 📅 2026-07-28 - Potentially dangerous files by [@Bo0oM](https://github.com/Bo0oM).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,644 | 🐛 107 | 🌐 Go | 📅 2026-08-20 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
...
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,041 | 🐛 6 | 🌐 Go | 📅 2026-08-19 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision, maintained by [@j3ssie](https://github.com/j3ssie).
...
* [Astra](https://github.com/flipkart-incubator/astra) ⭐ 2,658 | 🐛 66 | 🌐 Python | 📅 2024-06-05 - Automated Security Testing For REST API's by [@flipkart-incubator](https://github.com/flipkart-incubator).
...
* [ARS3NAL](https://github.com/inflictx/Arsenal) ⭐ 169 | 🐛 4 | 🌐 CSS | 📅 2026-07-09 - Offline-first, self-hosted pentest & bug-bounty arsenal - searchable payloads, a click-to-build command generator, GTFOBins, wordlists, an embedded CyberChef, reverse shells and per-vulnerability checklists, with a live static demo - by [@inflictx](https://github.com/inflictx).
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,147 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - XSStrike is a program which can fuzz and bruteforce parameters for XSS. It can also detect and bypass WAFs by [@s0md3v](https://github.com/s0md3v).
* [beef](https://github.com/beefproject/beef) ⭐ 10,979 | 🐛 38 | 🌐 JavaScript | 📅 2026-08-21 - The Browser Exploitation Framework Project by [beefproject](https://beefproject.com).
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 28,899 | 🐛 461 | 🌐 Go | 📅 2026-08-19 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
...
* [snallygaster](https://github.com/hannob/snallygaster) ⭐ 2,110 | 🐛 12 | 🌐 Python | 📅 2026-02-04 - Tool to scan for secret files on HTTP servers by [@hannob](https://github.com/hannob).
...
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,161 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-22 - Scanner detecting the use of JavaScript libraries with known vulnerabilities by [@RetireJS](https://github.com/RetireJS).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,321 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-21 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
...
* [Pompelmi](https://github.com/pompelmi/pompelmi) ⭐ 672 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-23 - In-process file-upload security middleware for Node.js that scans untrusted uploads before storage to detect malware, MIME spoofing, and risky archives, maintained by [pompelmi](https://github.com/pompelmi).
* [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 189 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-20 - Self-hosted CAPTCHA with behavioral analysis, vision-AI agent detection, headless-browser fingerprinting, and SHA-256 proof-of-work, maintained by [WebDecoy](https://github.com/WebDecoy).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,775 | 🐛 463 | 🌐 Python | 📅 2026-08-21 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,050 | 🐛 4 | 🌐 Rust | 📅 2026-08-21 - Single-binary intercepting proxy for HTTP, HTTPS, and WebSocket traffic that pauses and edits requests in flight, replays them, rewrites traffic with Lua hooks, and exports captures as HAR, curl, or raw HTTP, available as a terminal UI, web GUI, or headless REST API, by [@emanuele-em](https://github.com/emanuele-em).
...
* [webshell](https://github.com/tennc/webshell) ⭐ 10,774 | 🐛 0 | 🌐 PHP | 📅 2024-12-24 - This is a webshell open source project by [@tennc](https://github.com/tennc).
...
* [PhpSploit](https://github.com/nil0x42/phpsploit) ⭐ 2,490 | 🐛 27 | 🌐 Python | 📅 2024-05-06 - Full-featured C2 framework which silently persists on webserver via evil PHP oneliner by [@nil0x42](https://github.com/nil0x42).
...
* [radare2](https://github.com/radare/radare2) ⭐ 24,616 | 🐛 823 | 🌐 C | 📅 2026-08-22 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,635 | 🐛 555 | 🌐 JavaScript | 📅 2026-08-21 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,704 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-21 - Probably the most modern and sophisticated insecure web application - Written by [@bkimminich](https://github.com/bkimminich) and the [@owasp\_juiceshop](https://twitter.com/owasp_juiceshop) team.
...
* [OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 40 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-21 - Intentionally vulnerable e-commerce application built with Next.js - Written by [@kOaDT](https://github.com/kOaDT).
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,702 | 🐛 24 | 🌐 Python | 📅 2026-04-28 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool  - Written by [@RhinoSecurityLabs](https://github.com/RhinoSecurityLabs).
...
* [Infosec\_Reference](https://github.com/rmusser01/Infosec_Reference) ⭐ 5,986 | 🐛 5 | 🌐 CSS | 📅 2025-10-20 - Information Security Reference That Doesn't Suck by [@rmusser01](https://github.com/rmusser01).
* [awesome-bug-bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,865 | 🐛 30 | 📅 2026-03-07 - Comprehensive curated list of available Bug Bounty & Disclosure Programs and write-ups by [@djadmin](https://github.com/djadmin).
* [bug-bounty-reference](https://github.com/ngalongc/bug-bounty-reference) ⭐ 4,253 | 🐛 3 | 📅 2024-07-31 - List of bug bounty write-up that is categorized by the bug nature by [@ngalongc](https://github.com/ngalongc).
...
* [htb-writeups](https://github.com/momenbasel/htb-writeups) ⭐ 222 | 🐛 0 | 🌐 HTML | 📅 2026-07-18 - Comprehensive Hack The Box writeup collection covering 75+ web challenges including XSS, SQLi, SSTI, SSRF, and deserialization, by [@momenbasel](https://github.com/momenbasel).
