...
For [Codex](https://github.com/openai/codex) ⭐ 125,714 | 🐛 18,121 | 🌐 Rust | 📅 2026-09-21, swap `-a claude-code` → `-a codex`.
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,750 | 🐛 734 | 🌐 Ruby | 📅 2026-09-21 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Cross-Site%20Request%20Forgery) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 81,023 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [Altus iX Developer XAML Deserialization RCE](https://0day-rubbish.com/blog/altus-ix-developer-xaml-rce) - Root-cause analysis and reproducible PoC for a XAML deserialization RCE (CVSS 7.3) in a SCADA HMI engineering IDE, including affected versions and a self-contained exploit script, published by [0day Rubbish](https://github.com/Exploit-Garbage/0day-Rubbish) ⭐ 217 | 🐛 0 | 🌐 Python | 📅 2026-09-21.
...
* [Capture the Flag CheatSheet](https://github.com/uppusaikiran/awesome-ctf-cheatsheet) ⭐ 143 | 🐛 0 | 📅 2025-04-29 - Written by [@uppusaikiran](https://github.com/uppusaikiran).
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 14,844 | 🐛 384 | 🌐 Python | 📅 2026-09-21 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,853 | 🐛 4 | 🌐 Python | 📅 2026-09-21 - Automated All-in-One OS command injection and exploitation tool by [@commixproject](https://github.com/commixproject).
...
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,441 | 🐛 320 | 🌐 Python | 📅 2026-04-13 - Open source footprinting and intelligence-gathering tool by [@binarypool](https://twitter.com/binarypool).
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,219 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Incredibly fast crawler designed for OSINT by [@s0md3v](https://github.com/s0md3v).
...
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,028 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning by [@evyatarmeged](https://github.com/evyatarmeged).
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,637 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - FOCA (Fingerprinting Organizations with Collected Archives) is a tool used mainly to find metadata and hidden information in the documents its scans by [ElevenPaths](https://www.elevenpaths.com/index.html).
...
* [ReconDog](https://github.com/s0md3v/ReconDog) ⭐ 2,112 | 🐛 15 | 🌐 Python | 📅 2021-01-26 - Reconnaissance Swiss Army Knife by [@s0md3v](https://github.com/s0md3v).
...
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,581 | 🐛 118 | 🌐 Python | 📅 2026-01-21 - Web application bruteforcer by [@xmendez](https://github.com/xmendez).
...
* [SpiderSuite](https://github.com/spidersuite/SpiderSuite) ⭐ 979 | 🐛 12 | 📅 2026-08-13 - Cross-platform web security crawler supporting standard, headless, interactive, brute-force, and archive crawling modes, for attack-surface mapping and endpoint discovery, by [@3nock](https://github.com/3nock).
...
* [wayparam](https://github.com/aleff-github/wayparam) ⭐ 8 | 🐛 4 | 🌐 Python | 📅 2026-09-21 - Cross-platform Python CLI that fetches historical URLs from the Wayback CDX API and outputs normalized parameterized URLs for fuzzing, by [@aleff-github](https://github.com/aleff-github).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,407 | 🐛 106 | 🌐 Go | 📅 2026-09-21 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,778 | 🐛 1 | 🌐 Ruby | 📅 2026-09-21 - WPScan is a black box WordPress vulnerability scanner by [@wpscanteam](https://github.com/wpscanteam).
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,080 | 🐛 4 | 🌐 Go | 📅 2026-09-20 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision, maintained by [@j3ssie](https://github.com/j3ssie).
* [JoomlaScan](https://github.com/drego85/JoomlaScan) ⭐ 266 | 🐛 5 | 🌐 Python | 📅 2023-08-01 - Free software to find the components installed in Joomla CMS, built out of the ashes of Joomscan by [@drego85](https://github.com/drego85).
...
* [Astra](https://github.com/flipkart-incubator/astra) ⭐ 2,665 | 🐛 66 | 🌐 Python | 📅 2024-06-05 - Automated Security Testing For REST API's by [@flipkart-incubator](https://github.com/flipkart-incubator).
...
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 957 | 🐛 2 | 🌐 Python | 📅 2026-09-21 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks and MCP across web, cloud, Active Directory and Kubernetes, with an evidence trail per finding by [@ASCIT31](https://github.com/ASCIT31).
* [numasec](https://github.com/FrancescoStabile/numasec) ⭐ 794 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-08 - AI-driven penetration-testing platform that coordinates 10 agents and 38 vulnerability scanners covering OWASP Top 10, by [@FrancescoStabile](https://github.com/FrancescoStabile).
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,189 | 🐛 96 | 🌐 Python | 📅 2025-04-26 - XSStrike is a program which can fuzz and bruteforce parameters for XSS. It can also detect and bypass WAFs by [@s0md3v](https://github.com/s0md3v).
* [beef](https://github.com/beefproject/beef) ⭐ 11,023 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-16 - The Browser Exploitation Framework Project by [beefproject](https://beefproject.com).
...
* [XSRFProbe](https://github.com/0xInfection/XSRFProbe) ⭐ 1,305 | 🐛 0 | 🌐 Python | 📅 2026-07-12 - The Prime CSRF Audit & Exploitation Toolkit by [@0xInfection](https://github.com/0xinfection).
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,412 | 🐛 483 | 🌐 Go | 📅 2026-09-09 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
* [LinkFinder](https://github.com/GerbenJavado/LinkFinder) ⭐ 4,448 | 🐛 53 | 🌐 Python | 📅 2024-04-13 - Python script that finds endpoints in JavaScript files by [@GerbenJavado](https://github.com/GerbenJavado).
...
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,178 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-21 - Scanner detecting the use of JavaScript libraries with known vulnerabilities by [@RetireJS](https://github.com/RetireJS).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,409 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-19 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
...
* [UUSEC WAF](https://github.com/Safe3/uusec-waf/) ⭐ 1,713 | 🐛 83 | 🌐 Shell | 📅 2026-09-20 - An open-source web application firewall and API security gateway maintained by [UUCORP](https://github.com/Safe3/).
...
* [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 213 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-21 - Self-hosted CAPTCHA with behavioral analysis, vision-AI agent detection, headless-browser fingerprinting, and SHA-256 proof-of-work, maintained by [WebDecoy](https://github.com/WebDecoy).
...
* [WebDecoy](https://github.com/WebDecoy/wordpress-plugin) ⭐ 1 | 🐛 4 | 🌐 PHP | 📅 2026-09-21 - Zero-configuration WordPress bot-detection plugin combining WebDriver detection, headless-browser fingerprinting, behavioral analysis, and SHA-256 proof-of-work, maintained by [WebDecoy](https://github.com/WebDecoy).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,109 | 🐛 492 | 🌐 Python | 📅 2026-09-10 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,071 | 🐛 2 | 🌐 Rust | 📅 2026-09-21 - Single-binary intercepting proxy for HTTP, HTTPS, and WebSocket traffic that pauses and edits requests in flight, replays them, rewrites traffic with Lua hooks, and exports captures as HAR, curl, or raw HTTP, available as a terminal UI, web GUI, or headless REST API, by [@emanuele-em](https://github.com/emanuele-em).
...
* [webshell](https://github.com/tennc/webshell) ⭐ 10,777 | 🐛 0 | 🌐 PHP | 📅 2024-12-24 - This is a webshell open source project by [@tennc](https://github.com/tennc).
...
* [radare2](https://github.com/radare/radare2) ⭐ 24,840 | 🐛 827 | 🌐 C | 📅 2026-09-21 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,904 | 🐛 588 | 🌐 JavaScript | 📅 2026-09-21 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,913 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-21 - Probably the most modern and sophisticated insecure web application - Written by [@bkimminich](https://github.com/bkimminich) and the [@owasp\_juiceshop](https://twitter.com/owasp_juiceshop) team.
...
* [OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 45 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-21 - Intentionally vulnerable e-commerce application built with Next.js - Written by [@kOaDT](https://github.com/kOaDT).
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,732 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool  - Written by [@RhinoSecurityLabs](https://github.com/RhinoSecurityLabs).
...
* [htb-writeups](https://github.com/momenbasel/htb-writeups) ⭐ 258 | 🐛 0 | 🌐 HTML | 📅 2026-07-18 - Comprehensive Hack The Box writeup collection covering 75+ web challenges including XSS, SQLi, SSTI, SSRF, and deserialization, by [@momenbasel](https://github.com/momenbasel).
