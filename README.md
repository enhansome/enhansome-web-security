...
For [Codex](https://github.com/openai/codex) ⭐ 106,181 | 🐛 12,738 | 🌐 Rust | 📅 2026-08-16, swap `-a claude-code` → `-a codex`.
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).

<a name="sql-injection"></a>

### SQL Injection

* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,679 | 🐛 664 | 🌐 Ruby | 📅 2026-08-16 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSRF%20Injection) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 80,080 | 🐛 34 | 🌐 Python | 📅 2026-08-09 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [Altus iX Developer XAML Deserialization RCE](https://0day-rubbish.com/blog/altus-ix-developer-xaml-rce) - Root-cause analysis and reproducible PoC for a XAML deserialization RCE (CVSS 7.3) in a SCADA HMI engineering IDE, including affected versions and a self-contained exploit script, published by [0day Rubbish](https://github.com/Exploit-Garbage/0day-Rubbish) ⭐ 136 | 🐛 0 | 🌐 Python | 📅 2026-08-15.
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 14,590 | 🐛 275 | 🌐 Python | 📅 2026-08-14 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,816 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - Automated All-in-One OS command injection and exploitation tool by [@commixproject](https://github.com/commixproject).
...
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,115 | 🐛 59 | 🌐 Python | 📅 2026-08-07 - Incredibly fast crawler designed for OSINT by [@s0md3v](https://github.com/s0md3v).
...
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 3,992 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning by [@evyatarmeged](https://github.com/evyatarmeged).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,528 | 🐛 105 | 🌐 Go | 📅 2026-08-15 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
...
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 999 | 🐛 4 | 🌐 Go | 📅 2026-08-15 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision, maintained by [@j3ssie](https://github.com/j3ssie).
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,138 | 🐛 95 | 🌐 Python | 📅 2025-04-26 - XSStrike is a program which can fuzz and bruteforce parameters for XSS. It can also detect and bypass WAFs by [@s0md3v](https://github.com/s0md3v).
* [beef](https://github.com/beefproject/beef) ⭐ 10,979 | 🐛 38 | 🌐 JavaScript | 📅 2026-08-14 - The Browser Exploitation Framework Project by [beefproject](https://beefproject.com).
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,201 | 🐛 32 | 🌐 Python | 📅 2026-08-15 - Automatic SQL injection and database takeover tool.
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 28,748 | 🐛 463 | 🌐 Go | 📅 2026-07-29 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,306 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-16 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,707 | 🐛 469 | 🌐 Python | 📅 2026-08-13 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).
...
* [radare2](https://github.com/radare/radare2) ⭐ 24,579 | 🐛 821 | 🌐 C | 📅 2026-08-16 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,588 | 🐛 564 | 🌐 JavaScript | 📅 2026-08-14 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,674 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-10 - Probably the most modern and sophisticated insecure web application - Written by [@bkimminich](https://github.com/bkimminich) and the [@owasp\_juiceshop](https://twitter.com/owasp_juiceshop) team.
...
* [OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-16 - Intentionally vulnerable e-commerce application built with Next.js - Written by [@kOaDT](https://github.com/kOaDT).
...
* [awesome-bug-bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,853 | 🐛 30 | 📅 2026-03-07 - Comprehensive curated list of available Bug Bounty & Disclosure Programs and write-ups by [@djadmin](https://github.com/djadmin).
* [bug-bounty-reference](https://github.com/ngalongc/bug-bounty-reference) ⭐ 4,244 | 🐛 3 | 📅 2024-07-31 - List of bug bounty write-up that is categorized by the bug nature by [@ngalongc](https://github.com/ngalongc).
