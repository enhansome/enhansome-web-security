...
For [Codex](https://github.com/openai/codex) ⭐ 119,990 | 🐛 14,474 | 🌐 Rust | 📅 2026-08-30, swap `-a claude-code` → `-a codex`.
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,695 | 🐛 690 | 🌐 Ruby | 📅 2026-08-30 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSRF%20Injection) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 80,499 | 🐛 35 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [Altus iX Developer XAML Deserialization RCE](https://0day-rubbish.com/blog/altus-ix-developer-xaml-rce) - Root-cause analysis and reproducible PoC for a XAML deserialization RCE (CVSS 7.3) in a SCADA HMI engineering IDE, including affected versions and a self-contained exploit script, published by [0day Rubbish](https://github.com/Exploit-Garbage/0day-Rubbish) ⭐ 190 | 🐛 0 | 🌐 Python | 📅 2026-08-26.
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 14,718 | 🐛 341 | 🌐 Python | 📅 2026-08-28 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,830 | 🐛 4 | 🌐 Python | 📅 2026-08-25 - Automated All-in-One OS command injection and exploitation tool by [@commixproject](https://github.com/commixproject).
...
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,005 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning by [@evyatarmeged](https://github.com/evyatarmeged).
...
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,561 | 🐛 117 | 🌐 Python | 📅 2026-01-21 - Web application bruteforcer by [@xmendez](https://github.com/xmendez).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 30,930 | 🐛 108 | 🌐 Go | 📅 2026-08-26 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
...
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 878 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks and MCP across web, cloud, Active Directory and Kubernetes, with an evidence trail per finding by [@ASCIT31](https://github.com/ASCIT31).
* [numasec](https://github.com/FrancescoStabile/numasec) ⭐ 619 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-08 - AI-driven penetration-testing platform that coordinates 10 agents and 38 vulnerability scanners covering OWASP Top 10, by [@FrancescoStabile](https://github.com/FrancescoStabile).
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,161 | 🐛 94 | 🌐 Python | 📅 2025-04-26 - XSStrike is a program which can fuzz and bruteforce parameters for XSS. It can also detect and bypass WAFs by [@s0md3v](https://github.com/s0md3v).
* [beef](https://github.com/beefproject/beef) ⭐ 10,992 | 🐛 37 | 🌐 JavaScript | 📅 2026-08-28 - The Browser Exploitation Framework Project by [beefproject](https://beefproject.com).
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,317 | 🐛 34 | 🌐 Python | 📅 2026-08-28 - Automatic SQL injection and database takeover tool.
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,015 | 🐛 470 | 🌐 Go | 📅 2026-08-26 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,348 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-29 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
...
* [UUSEC WAF](https://github.com/Safe3/uusec-waf/) ⭐ 1,707 | 🐛 83 | 🌐 Shell | 📅 2026-08-23 - An open-source web application firewall and API security gateway maintained by [UUCORP](https://github.com/Safe3/).
...
* [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 195 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-23 - Self-hosted CAPTCHA with behavioral analysis, vision-AI agent detection, headless-browser fingerprinting, and SHA-256 proof-of-work, maintained by [WebDecoy](https://github.com/WebDecoy).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,854 | 🐛 470 | 🌐 Python | 📅 2026-08-25 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).
...
* [radare2](https://github.com/radare/radare2) ⭐ 24,681 | 🐛 821 | 🌐 C | 📅 2026-08-30 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,695 | 🐛 551 | 🌐 JavaScript | 📅 2026-08-29 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,745 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-28 - Probably the most modern and sophisticated insecure web application - Written by [@bkimminich](https://github.com/bkimminich) and the [@owasp\_juiceshop](https://twitter.com/owasp_juiceshop) team.
...
* [awesome-bug-bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,880 | 🐛 30 | 📅 2026-03-07 - Comprehensive curated list of available Bug Bounty & Disclosure Programs and write-ups by [@djadmin](https://github.com/djadmin).
* [bug-bounty-reference](https://github.com/ngalongc/bug-bounty-reference) ⭐ 4,259 | 🐛 3 | 📅 2024-07-31 - List of bug bounty write-up that is categorized by the bug nature by [@ngalongc](https://github.com/ngalongc).
...
* [htb-writeups](https://github.com/momenbasel/htb-writeups) ⭐ 232 | 🐛 0 | 🌐 HTML | 📅 2026-07-18 - Comprehensive Hack The Box writeup collection covering 75+ web challenges including XSS, SQLi, SSTI, SSRF, and deserialization, by [@momenbasel](https://github.com/momenbasel).
