# Awesome Web Security with stars
...
For [Codex](https://github.com/openai/codex) ⭐ 126,300 | 🐛 18,578 | 🌐 Rust | 📅 2026-09-24, swap `-a claude-code` → `-a codex`.
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [AwesomeXSS](https://github.com/s0md3v/AwesomeXSS) ⭐ 5,145 | 🐛 1 | 🌐 JavaScript | 📅 2024-10-30 - Written by [@s0md3v](https://github.com/s0md3v).
* [H5SC](https://github.com/cure53/H5SC) ⭐ 2,938 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-09 - Written by [@cure53](https://github.com/cure53).
...
* [Prototype pollution attack in NodeJS application](https://github.com/HoLyVieR/prototype-pollution-nsec18/blob/master/paper/JavaScript_prototype_pollution_attack_in_NodeJS.pdf) ⭐ 540 | 🐛 1 | 🌐 JavaScript | 📅 2024-05-25 - Written by [@HoLyVieR](https://github.com/HoLyVieR).

<a name="csv-injection"></a>

### CSV Injection

* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,752 | 🐛 716 | 🌐 Ruby | 📅 2026-09-24 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Cross-Site%20Request%20Forgery) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [X-Frame-Options: All about Clickjacking?](https://github.com/cure53/Publications/blob/master/xfo-clickjacking.pdf?raw=true) ⭐ 93 | 🐛 0 | 📅 2026-06-23 - Written by [Mario Heiderich](https://www.slideshare.net/x00mario).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 81,165 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [Zen Rails Security Checklist](https://github.com/brunofacca/zen-rails-security-checklist) ⭐ 1,811 | 🐛 1 | 🌐 Ruby | 📅 2020-03-09 - Written by [@brunofacca](https://github.com/brunofacca).
...
* [Practical introduction to SSL/TLS](https://github.com/Hakky54/mutual-tls-ssl) ⭐ 637 | 🐛 0 | 🌐 Java | 📅 2026-09-18 - Written by [@Hakky54](https://github.com/Hakky54).
...
* [Altus iX Developer XAML Deserialization RCE](https://0day-rubbish.com/blog/altus-ix-developer-xaml-rce) - Root-cause analysis and reproducible PoC for a XAML deserialization RCE (CVSS 7.3) in a SCADA HMI engineering IDE, including affected versions and a self-contained exploit script, published by [0day Rubbish](https://github.com/Exploit-Garbage/0day-Rubbish) ⭐ 219 | 🐛 0 | 🌐 Python | 📅 2026-09-23.
...
* [Any protection against dynamic module import?](https://github.com/w3c/webappsec-csp/issues/243) ⭐ 224 | 🐛 202 | 🌐 HTML | 📅 2026-09-16 - Written by [@shhnjk](https://twitter.com/@shhnjk).
...
* [Stealing CSRF tokens with CSS injection (without iFrames)](https://github.com/dxa4481/cssInjection) ⭐ 320 | 🐛 1 | 🌐 HTML | 📅 2018-02-07 - Written by [@dxa4481](https://github.com/dxa4481).
...
* [Inducing DNS Leaks in Onion Web Services](https://github.com/epidemics-scepticism/writing/blob/master/onion-dns-leaks.md) ⭐ 41 | 🐛 0 | 📅 2018-07-11 - Written by [@epidemics-scepticism](https://github.com/epidemics-scepticism).
...
* [awesome-cve-poc](https://github.com/qazbnm456/awesome-cve-poc) ⭐ 3,534 | 🐛 2 | 📅 2022-01-04 - Curated list of CVE PoCs by [@qazbnm456](https://github.com/qazbnm456).
* [Some-PoC-oR-ExP](https://github.com/coffeehb/Some-PoC-oR-ExP) ⭐ 2,502 | 🐛 2 | 🌐 Python | 📅 2025-06-24 - 各种漏洞poc、Exp的收集或编写 by [@coffeehb](https://github.com/coffeehb).
* [js-vuln-db](https://github.com/tunz/js-vuln-db) ⭐ 2,321 | 🐛 0 | 📅 2019-09-03 - Collection of JavaScript engine CVEs with PoCs by [@tunz](https://github.com/tunz).
* [uxss-db](https://github.com/Metnew/uxss-db) ⭐ 704 | 🐛 0 | 🌐 HTML | 📅 2021-01-23 - Collection of UXSS CVEs with PoCs by [@Metnew](https://github.com/Metnew).
...
* [Capture the Flag CheatSheet](https://github.com/uppusaikiran/awesome-ctf-cheatsheet) ⭐ 144 | 🐛 0 | 📅 2025-04-29 - Written by [@uppusaikiran](https://github.com/uppusaikiran).
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 14,860 | 🐛 381 | 🌐 Python | 📅 2026-09-24 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,857 | 🐛 3 | 🌐 Python | 📅 2026-09-24 - Automated All-in-One OS command injection and exploitation tool by [@commixproject](https://github.com/commixproject).
...
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,483 | 🐛 320 | 🌐 Python | 📅 2026-04-13 - Open source footprinting and intelligence-gathering tool by [@binarypool](https://twitter.com/binarypool).
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,236 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Incredibly fast crawler designed for OSINT by [@s0md3v](https://github.com/s0md3v).
...
* [Social Mapper](https://github.com/Greenwolf/social_mapper) ⭐ 4,080 | 🐛 48 | 🌐 Python | 📅 2022-02-25 - Social Media Enumeration & Correlation Tool by [Jacob Wilkin (Greenwolf)](https://github.com/Greenwolf).
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,032 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning by [@evyatarmeged](https://github.com/evyatarmeged).
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,638 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - FOCA (Fingerprinting Organizations with Collected Archives) is a tool used mainly to find metadata and hidden information in the documents its scans by [ElevenPaths](https://www.elevenpaths.com/index.html).
...
* [ReconDog](https://github.com/s0md3v/ReconDog) ⭐ 2,114 | 🐛 15 | 🌐 Python | 📅 2021-01-26 - Reconnaissance Swiss Army Knife by [@s0md3v](https://github.com/s0md3v).
* [tinfoleak](https://github.com/vaguileradiaz/tinfoleak) ⭐ 1,984 | 🐛 28 | 🌐 Python | 📅 2019-02-06 - The most complete open-source tool for Twitter intelligence analysis by [@vaguileradiaz](https://github.com/vaguileradiaz).
* [raven](https://github.com/0x09AL/raven) ⭐ 801 | 🐛 3 | 🌐 Go | 📅 2020-05-18 - raven is a Linkedin information gathering tool that can be used by pentesters to gather information about an organization employees using Linkedin by [@0x09AL](https://github.com/0x09AL).
...
* [Marshall Extensions](https://github.com/bad-antics/marshall-extensions) ⭐ 8 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-27 - OSINT and security extensions for the Marshall privacy browser, providing reconnaissance and security-testing plugins by [@bad-antics](https://github.com/bad-antics).
...
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,045 | 🐛 254 | 🌐 Python | 📅 2024-08-02 - Sublist3r is a multi-threaded sub-domain enumeration tool for penetration testers by [@aboul3la](https://github.com/aboul3la).
...
* [subDomainsBrute](https://github.com/lijiejie/subDomainsBrute) ⭐ 3,620 | 🐛 16 | 🌐 Python | 📅 2022-09-15 - A simple and fast sub domain brute tool for pentesters by [@lijiejie](https://github.com/lijiejie).
...
* [EyeWitness](https://github.com/ChrisTruncer/EyeWitness) ⭐ 65 | 🐛 0 | 📅 2024-05-31 - EyeWitness is designed to take screenshots of websites, provide some server header info, and identify default credentials if possible by [@ChrisTruncer](https://github.com/ChrisTruncer).
...
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,582 | 🐛 118 | 🌐 Python | 📅 2026-01-21 - Web application bruteforcer by [@xmendez](https://github.com/xmendez).
* [fuzz.txt](https://github.com/Bo0oM/fuzz.txt) ⭐ 3,330 | 🐛 8 | 📅 2026-07-28 - Potentially dangerous files by [@Bo0oM](https://github.com/Bo0oM).
* [dirhunt](https://github.com/Nekmo/dirhunt) ⭐ 2,006 | 🐛 15 | 🌐 Python | 📅 2023-10-29 - Web crawler optimized for searching and analyzing the directory structure of a site by [@nekmo](https://github.com/Nekmo).
* [domato](https://github.com/google/domato) ⭐ 1,783 | 🐛 3 | 🌐 Python | 📅 2024-11-26 - DOM fuzzer by [@google](https://github.com/google).
* [SpiderSuite](https://github.com/spidersuite/SpiderSuite) ⭐ 977 | 🐛 12 | 📅 2026-08-13 - Cross-platform web security crawler supporting standard, headless, interactive, brute-force, and archive crawling modes, for attack-surface mapping and endpoint discovery, by [@3nock](https://github.com/3nock).
...
* [wayparam](https://github.com/aleff-github/wayparam) ⭐ 8 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - Cross-platform Python CLI that fetches historical URLs from the Wayback CDX API and outputs normalized parameterized URLs for fuzzing, by [@aleff-github](https://github.com/aleff-github).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,486 | 🐛 111 | 🌐 Go | 📅 2026-09-24 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,778 | 🐛 6 | 🌐 Ruby | 📅 2026-09-23 - WPScan is a black box WordPress vulnerability scanner by [@wpscanteam](https://github.com/wpscanteam).
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,084 | 🐛 4 | 🌐 Go | 📅 2026-09-22 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision, maintained by [@j3ssie](https://github.com/j3ssie).
* [JoomlaScan](https://github.com/drego85/JoomlaScan) ⭐ 265 | 🐛 5 | 🌐 Python | 📅 2023-08-01 - Free software to find the components installed in Joomla CMS, built out of the ashes of Joomscan by [@drego85](https://github.com/drego85).
* [ZeroTrust](https://github.com/sattyamjjain/zerotrust) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2025-11-29 - Privacy-first Chrome extension that analyzes website security locally with on-device AI (WebGPU), producing trust scores from HTTPS, phishing, malicious-script, and cookie-compliance signals, by [@sattyamjjain](https://github.com/sattyamjjain).
* [Trust Scan](https://github.com/undeadlist/trust-scan) ⭐ 5 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-25 - URL security scanner combining threat intelligence (URLhaus, PhishTank, Spamhaus) with 40+ scam and phishing pattern detection by [@undeadlist](https://github.com/undeadlist).
...
* [Astra](https://github.com/flipkart-incubator/astra) ⭐ 2,667 | 🐛 66 | 🌐 Python | 📅 2024-06-05 - Automated Security Testing For REST API's by [@flipkart-incubator](https://github.com/flipkart-incubator).
* [TIDoS-Framework](https://github.com/theInfectedDrake/TIDoS-Framework) ⭐ 1,869 | 🐛 16 | 🌐 Python | 📅 2023-04-19 - A comprehensive web application audit framework to cover up everything from Reconnaissance and OSINT to Vulnerability Analysis by [@\_tID](https://github.com/theInfectedDrake).
...
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 967 | 🐛 3 | 🌐 Python | 📅 2026-09-24 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks and MCP across web, cloud, Active Directory and Kubernetes, with an evidence trail per finding by [@ASCIT31](https://github.com/ASCIT31).
* [numasec](https://github.com/FrancescoStabile/numasec) ⭐ 793 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-08 - AI-driven penetration-testing platform that coordinates 10 agents and 38 vulnerability scanners covering OWASP Top 10, by [@FrancescoStabile](https://github.com/FrancescoStabile).
* [ARS3NAL](https://github.com/inflictx/Arsenal) ⭐ 177 | 🐛 4 | 🌐 CSS | 📅 2026-07-09 - Offline-first, self-hosted pentest & bug-bounty arsenal - searchable payloads, a click-to-build command generator, GTFOBins, wordlists, an embedded CyberChef, reverse shells and per-vulnerability checklists, with a live static demo - by [@inflictx](https://github.com/inflictx).
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,190 | 🐛 96 | 🌐 Python | 📅 2025-04-26 - XSStrike is a program which can fuzz and bruteforce parameters for XSS. It can also detect and bypass WAFs by [@s0md3v](https://github.com/s0md3v).
* [beef](https://github.com/beefproject/beef) ⭐ 11,025 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-22 - The Browser Exploitation Framework Project by [beefproject](https://beefproject.com).
* [xssor2](https://github.com/evilcos/xssor2) ⭐ 2,220 | 🐛 4 | 🌐 JavaScript | 📅 2021-12-12 - XSS'OR - Hack with JavaScript by [@evilcos](https://github.com/evilcos).
* [JShell](https://github.com/s0md3v/JShell) ⭐ 529 | 🐛 1 | 🌐 Python | 📅 2019-05-05 - Get a JavaScript shell with XSS by [@s0md3v](https://github.com/s0md3v).
...
* [tplmap](https://github.com/epinna/tplmap) ⭐ 4,205 | 🐛 46 | 🌐 Python | 📅 2024-04-21 - Code and Server-Side Template Injection Detection and Exploitation Tool by [@epinna](https://github.com/epinna).

<a name="tools-xxe"></a>

#### XXE

* [dtd-finder](https://github.com/GoSecure/dtd-finder) ⭐ 665 | 🐛 1 | 🌐 Kotlin | 📅 2024-02-21 - List DTDs and generate XXE payloads using those local DTDs by [@GoSecure](https://github.com/GoSecure).

<a name="tools-csrf"></a>

#### Cross Site Request Forgery

* [XSRFProbe](https://github.com/0xInfection/XSRFProbe) ⭐ 1,306 | 🐛 0 | 🌐 Python | 📅 2026-07-12 - The Prime CSRF Audit & Exploitation Toolkit by [@0xInfection](https://github.com/0xinfection).
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,464 | 🐛 484 | 🌐 Go | 📅 2026-09-23 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
* [LinkFinder](https://github.com/GerbenJavado/LinkFinder) ⭐ 4,447 | 🐛 53 | 🌐 Python | 📅 2024-04-13 - Python script that finds endpoints in JavaScript files by [@GerbenJavado](https://github.com/GerbenJavado).
* [CSS-Keylogging](https://github.com/maxchehab/CSS-Keylogging) ⭐ 3,239 | 🐛 0 | 🌐 CSS | 📅 2018-02-20 - Chrome extension and Express server that exploits keylogging abilities of CSS by [@maxchehab](https://github.com/maxchehab).
...
* [HTTPLeaks](https://github.com/cure53/HTTPLeaks) ⭐ 2,124 | 🐛 0 | 🌐 HTML | 📅 2026-09-09 - All possible ways, a website can leak HTTP requests by [@cure53](https://github.com/cure53).
* [snallygaster](https://github.com/hannob/snallygaster) ⭐ 2,112 | 🐛 12 | 🌐 Python | 📅 2026-02-04 - Tool to scan for secret files on HTTP servers by [@hannob](https://github.com/hannob).
* [dvcs-ripper](https://github.com/kost/dvcs-ripper) ⭐ 1,786 | 🐛 11 | 🌐 Perl | 📅 2024-07-19 - Rip web accessible (distributed) version control systems: SVN/GIT/HG... by [@kost](https://github.com/kost).
* [keyFinder](https://github.com/momenbasel/keyFinder) ⭐ 718 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-19 - Chrome extension that passively scans web pages for leaked API keys, tokens, and credentials across 10 attack surfaces using 80+ detection patterns and Shannon-entropy analysis, by [@momenbasel](https://github.com/momenbasel).
* [DVCS-Pillage](https://github.com/evilpacket/DVCS-Pillage) ⭐ 331 | 🐛 7 | 🌐 Shell | 📅 2017-01-19 - Pillage web accessible GIT, HG and BZR repositories by [@evilpacket](https://github.com/evilpacket).
...
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,179 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-21 - Scanner detecting the use of JavaScript libraries with known vulnerabilities by [@RetireJS](https://github.com/RetireJS).
* [OpenRASP](https://github.com/baidu/openrasp) ⭐ 2,986 | 🐛 62 | 🌐 C++ | 📅 2025-10-02 - An open source RASP solution actively maintained by Baidu Inc. With context-aware detection algorithm the project achieved nearly no false positives. And less than 3% performance reduction is observed under heavy server load.
* [bXSS](https://github.com/LewisArdern/bXSS) ⭐ 578 | 🐛 20 | 🌐 JavaScript | 📅 2023-03-04 - bXSS is a simple Blind XSS application adapted from [cure53.de/m](https://cure53.de/m) by [@LewisArdern](https://github.com/LewisArdern).
* [malware-jail](https://github.com/HynekPetrak/malware-jail) ⭐ 480 | 🐛 5 | 🌐 JavaScript | 📅 2023-06-16 - Sandbox for semi-automatic Javascript malware analysis, deobfuscation and payload extraction by [@HynekPetrak](https://github.com/HynekPetrak).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,409 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-23 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
* [js-xss](https://github.com/leizongmin/js-xss) ⭐ 5,309 | 🐛 69 | 🌐 HTML | 📅 2026-05-06 - Sanitize untrusted HTML (to prevent XSS) with a configuration specified by a Whitelist by [@leizongmin](https://github.com/leizongmin).
* [UUSEC WAF](https://github.com/Safe3/uusec-waf/) ⭐ 1,712 | 🐛 83 | 🌐 Shell | 📅 2026-09-20 - An open-source web application firewall and API security gateway maintained by [UUCORP](https://github.com/Safe3/).
* [Acra](https://github.com/cossacklabs/acra) ⭐ 1,493 | 🐛 29 | 🌐 Go | 📅 2026-04-23 - Client-side encryption engine for SQL databases, with strong selective encryption, SQL injections prevention and intrusion detection by [@cossacklabs](https://www.cossacklabs.com/).
* [Pompelmi](https://github.com/pompelmi/pompelmi) ⭐ 677 | 🐛 6 | 🌐 JavaScript | 📅 2026-05-23 - In-process file-upload security middleware for Node.js that scans untrusted uploads before storage to detect malware, MIME spoofing, and risky archives, maintained by [pompelmi](https://github.com/pompelmi).
* [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 213 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-24 - Self-hosted CAPTCHA with behavioral analysis, vision-AI agent detection, headless-browser fingerprinting, and SHA-256 proof-of-work, maintained by [WebDecoy](https://github.com/WebDecoy).
* [verifyfetch](https://github.com/hamzaydia/verifyfetch) ⭐ 158 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-07 - Browser-side integrity verification and resumable downloads for large files using SRI hashes, defending against CDN compromise and supply-chain attacks, by [@hamzaydia](https://github.com/hamzaydia).
* [WebDecoy](https://github.com/WebDecoy/wordpress-plugin) ⭐ 1 | 🐛 4 | 🌐 PHP | 📅 2026-09-24 - Zero-configuration WordPress bot-detection plugin combining WebDriver detection, headless-browser fingerprinting, behavioral analysis, and SHA-256 proof-of-work, maintained by [WebDecoy](https://github.com/WebDecoy).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,142 | 🐛 496 | 🌐 Python | 📅 2026-09-10 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,072 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 - Single-binary intercepting proxy for HTTP, HTTPS, and WebSocket traffic that pauses and edits requests in flight, replays them, rewrites traffic with Lua hooks, and exports captures as HAR, curl, or raw HTTP, available as a terminal UI, web GUI, or headless REST API, by [@emanuele-em](https://github.com/emanuele-em).
...
* [webshell](https://github.com/tennc/webshell) ⭐ 10,780 | 🐛 0 | 🌐 PHP | 📅 2024-12-24 - This is a webshell open source project by [@tennc](https://github.com/tennc).
* [Weevely](https://github.com/epinna/weevely3) ⭐ 3,533 | 🐛 17 | 🌐 Python | 📅 2025-10-01 - Weaponized web shell by [@epinna](https://github.com/epinna).
* [PhpSploit](https://github.com/nil0x42/phpsploit) ⭐ 2,493 | 🐛 27 | 🌐 Python | 📅 2024-05-06 - Full-featured C2 framework which silently persists on webserver via evil PHP oneliner by [@nil0x42](https://github.com/nil0x42).
* [reverse-shell](https://github.com/lukechilds/reverse-shell) ⭐ 2,057 | 🐛 1 | 🌐 Go | 📅 2026-02-18 - Reverse Shell as a Service by [@lukechilds](https://github.com/lukechilds).
...
* [Webshell-Sniper](https://github.com/WangYihang/Webshell-Sniper) ⭐ 422 | 🐛 0 | 🌐 Python | 📅 2026-06-27 - Manage your website via terminal by [@WangYihang](https://github.com/WangYihang).
...
* [radare2](https://github.com/radare/radare2) ⭐ 24,867 | 🐛 824 | 🌐 C | 📅 2026-09-24 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
* [plasma](https://github.com/plasma-disassembler/plasma) ⭐ 3,069 | 🐛 15 | 🌐 Python | 📅 2021-08-31 - Plasma is an interactive disassembler for x86/ARM/MIPS by [@plasma-disassembler](https://github.com/plasma-disassembler).
* [Iaitō](https://github.com/hteso/iaito) ⭐ 1,458 | 🐛 38 | 🌐 C++ | 📅 2021-04-07 - Qt and C++ GUI for radare2 reverse engineering framework by [@hteso](https://github.com/hteso).
...
* [DNS Rebind Toolkit](https://github.com/brannondorsey/dns-rebind-toolkit) ⭐ 503 | 🐛 3 | 🌐 JavaScript | 📅 2021-10-02 - DNS Rebind Toolkit is a frontend JavaScript framework for developing DNS Rebinding exploits against vulnerable hosts and services on a local area network (LAN) by [@brannondorsey](https://github.com/brannondorsey).
* [dref](https://github.com/mwrlabs/dref) ⭐ 494 | 🐛 2 | 🌐 JavaScript | 📅 2021-04-27 - DNS Rebinding Exploitation Framework. Dref does the heavy-lifting for DNS rebinding by [@mwrlabs](https://github.com/mwrlabs).

<a name="tools-others"></a>

### Others

* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,944 | 🐛 585 | 🌐 JavaScript | 📅 2026-09-23 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
* [ctftool](https://github.com/taviso/ctftool) ⭐ 1,667 | 🐛 15 | 🌐 C | 📅 2021-09-17 - Interactive CTF Exploration Tool by [@taviso](https://github.com/taviso).
* [cefdebug](https://github.com/taviso/cefdebug) ⭐ 209 | 🐛 0 | 🌐 C | 📅 2020-06-10 - Minimal code to connect to a CEF debugger by [@taviso](https://github.com/taviso).
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,937 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-23 - Probably the most modern and sophisticated insecure web application - Written by [@bkimminich](https://github.com/bkimminich) and the [@owasp\_juiceshop](https://twitter.com/owasp_juiceshop) team.
...
* [OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 45 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-24 - Intentionally vulnerable e-commerce application built with Next.js - Written by [@kOaDT](https://github.com/kOaDT).
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,736 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool  - Written by [@RhinoSecurityLabs](https://github.com/RhinoSecurityLabs).
...
* [Infosec\_Reference](https://github.com/rmusser01/Infosec_Reference) ⭐ 5,994 | 🐛 4 | 🌐 CSS | 📅 2025-10-20 - Information Security Reference That Doesn't Suck by [@rmusser01](https://github.com/rmusser01).
* [awesome-bug-bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,910 | 🐛 31 | 📅 2026-03-07 - Comprehensive curated list of available Bug Bounty & Disclosure Programs and write-ups by [@djadmin](https://github.com/djadmin).
* [bug-bounty-reference](https://github.com/ngalongc/bug-bounty-reference) ⭐ 4,272 | 🐛 3 | 📅 2024-07-31 - List of bug bounty write-up that is categorized by the bug nature by [@ngalongc](https://github.com/ngalongc).
* [EQGRP](https://github.com/x0rz/EQGRP) ⭐ 4,204 | 🐛 18 | 🌐 Perl | 📅 2017-05-24 - Decrypted content of eqgrp-auction-file.tar.xz by [@x0rz](https://github.com/x0rz).
* [notes](https://github.com/ChALkeR/notes) ⭐ 1,276 | 🐛 1 | 📅 2019-07-13 - Some public notes by [@ChALkeR](https://github.com/ChALkeR).
* [htb-writeups](https://github.com/momenbasel/htb-writeups) ⭐ 259 | 🐛 0 | 🌐 HTML | 📅 2026-07-18 - Comprehensive Hack The Box writeup collection covering 75+ web challenges including XSS, SQLi, SSTI, SSRF, and deserialization, by [@momenbasel](https://github.com/momenbasel).
