...
For [Codex](https://github.com/openai/codex) ⭐ 126,560 | 🐛 18,933 | 🌐 Rust | 📅 2026-09-26, swap `-a claude-code` → `-a codex`.
...
* [PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings/) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - XSS Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XSS%20Injection) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - CSV Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/CSV%20Injection) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SQL Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SQL%20Injection) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Command Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Command%20Injection) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
* [Potential command injection in resolv.rb](https://github.com/ruby/ruby/pull/1777) ⭐ 23,754 | 🐛 727 | 🌐 Ruby | 📅 2026-09-26 - Written by [@drigg3r](https://github.com/drigg3r).
...
* [PayloadsAllTheThings - XXE Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/XXE%20Injection) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by various contributors.
...
* [PayloadsAllTheThings - CSRF Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Cross-Site%20Request%20Forgery) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Server-Side Request Forgery](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Server%20Side%20Request%20Forgery) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Web Cache Deception](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Web%20Cache%20Deception) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Open Redirect](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Open%20Redirect) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - SAML Injection](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/SAML%20Injection) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [PayloadsAllTheThings - Upload Insecure Files](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Upload%20Insecure%20Files) ⭐ 81,223 | 🐛 36 | 🌐 Python | 📅 2026-08-27 - Written by [@swisskyrepo](https://github.com/swisskyrepo).
...
* [Altus iX Developer XAML Deserialization RCE](https://0day-rubbish.com/blog/altus-ix-developer-xaml-rce) - Root-cause analysis and reproducible PoC for a XAML deserialization RCE (CVSS 7.3) in a SCADA HMI engineering IDE, including affected versions and a self-contained exploit script, published by [0day Rubbish](https://github.com/Exploit-Garbage/0day-Rubbish) ⭐ 222 | 🐛 0 | 🌐 Python | 📅 2026-09-23.
...
* [Any protection against dynamic module import?](https://github.com/w3c/webappsec-csp/issues/243) ⭐ 225 | 🐛 202 | 🌐 HTML | 📅 2026-09-16 - Written by [@shhnjk](https://twitter.com/@shhnjk).
...
* [awesome-cve-poc](https://github.com/qazbnm456/awesome-cve-poc) ⭐ 3,532 | 🐛 2 | 📅 2022-01-04 - Curated list of CVE PoCs by [@qazbnm456](https://github.com/qazbnm456).
...
* [prowler](https://github.com/Alfresco/prowler) ⭐ 14,868 | 🐛 382 | 🌐 Python | 📅 2026-09-25 - Tool for AWS security assessment, auditing and hardening by [@Alfresco](https://github.com/Alfresco).
...
* [commix](https://github.com/commixproject/commix) ⭐ 5,857 | 🐛 3 | 🌐 Python | 📅 2026-09-26 - Automated All-in-One OS command injection and exploitation tool by [@commixproject](https://github.com/commixproject).
...
* [SpiderFoot](https://github.com/smicallef/spiderfoot) ⭐ 22,531 | 🐛 321 | 🌐 Python | 📅 2026-04-13 - Open source footprinting and intelligence-gathering tool by [@binarypool](https://twitter.com/binarypool).
* [Photon](https://github.com/s0md3v/Photon) ⭐ 13,239 | 🐛 60 | 🌐 Python | 📅 2026-09-04 - Incredibly fast crawler designed for OSINT by [@s0md3v](https://github.com/s0md3v).
...
* [Social Mapper](https://github.com/Greenwolf/social_mapper) ⭐ 4,081 | 🐛 48 | 🌐 Python | 📅 2022-02-25 - Social Media Enumeration & Correlation Tool by [Jacob Wilkin (Greenwolf)](https://github.com/Greenwolf).
* [Raccoon](https://github.com/evyatarmeged/Raccoon) ⭐ 4,034 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - High performance offensive security tool for reconnaissance and vulnerability scanning by [@evyatarmeged](https://github.com/evyatarmeged).
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,643 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - FOCA (Fingerprinting Organizations with Collected Archives) is a tool used mainly to find metadata and hidden information in the documents its scans by [ElevenPaths](https://www.elevenpaths.com/index.html).
...
* [ReconDog](https://github.com/s0md3v/ReconDog) ⭐ 2,115 | 🐛 15 | 🌐 Python | 📅 2021-01-26 - Reconnaissance Swiss Army Knife by [@s0md3v](https://github.com/s0md3v).
...
* [Sublist3r](https://github.com/aboul3la/Sublist3r) ⭐ 11,046 | 🐛 254 | 🌐 Python | 📅 2024-08-02 - Sublist3r is a multi-threaded sub-domain enumeration tool for penetration testers by [@aboul3la](https://github.com/aboul3la).
...
* [wfuzz](https://github.com/xmendez/wfuzz) ⭐ 6,583 | 🐛 118 | 🌐 Python | 📅 2026-01-21 - Web application bruteforcer by [@xmendez](https://github.com/xmendez).
* [fuzz.txt](https://github.com/Bo0oM/fuzz.txt) ⭐ 3,331 | 🐛 8 | 📅 2026-07-28 - Potentially dangerous files by [@Bo0oM](https://github.com/Bo0oM).
...
* [Nuclei](https://github.com/projectdiscovery/nuclei) ⭐ 31,537 | 🐛 106 | 🌐 Go | 📅 2026-09-26 - Nuclei is a fast tool for configurable targeted scanning based on templates offering massive extensibility and ease of use by [@projectdiscovery](https://github.com/projectdiscovery).
* [wpscan](https://github.com/wpscanteam/wpscan) ⭐ 9,784 | 🐛 2 | 🌐 Ruby | 📅 2026-09-26 - WPScan is a black box WordPress vulnerability scanner by [@wpscanteam](https://github.com/wpscanteam).
* [Vigolium](https://github.com/vigolium/vigolium) ⭐ 1,083 | 🐛 4 | 🌐 Go | 📅 2026-09-24 - High-fidelity vulnerability scanner fusing agentic AI with native speed, modularity, and precision, maintained by [@j3ssie](https://github.com/j3ssie).
...
* [Astra](https://github.com/flipkart-incubator/astra) ⭐ 2,668 | 🐛 66 | 🌐 Python | 📅 2024-06-05 - Automated Security Testing For REST API's by [@flipkart-incubator](https://github.com/flipkart-incubator).
...
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 970 | 🐛 3 | 🌐 Python | 📅 2026-09-25 - Open source autonomous AI penetration testing platform that orchestrates 80+ offensive tools via Markdown playbooks and MCP across web, cloud, Active Directory and Kubernetes, with an evidence trail per finding by [@ASCIT31](https://github.com/ASCIT31).
* [numasec](https://github.com/FrancescoStabile/numasec) ⭐ 792 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-08 - AI-driven penetration-testing platform that coordinates 10 agents and 38 vulnerability scanners covering OWASP Top 10, by [@FrancescoStabile](https://github.com/FrancescoStabile).
...
* [XSStrike](https://github.com/s0md3v/XSStrike) ⭐ 15,194 | 🐛 96 | 🌐 Python | 📅 2025-04-26 - XSStrike is a program which can fuzz and bruteforce parameters for XSS. It can also detect and bypass WAFs by [@s0md3v](https://github.com/s0md3v).
* [beef](https://github.com/beefproject/beef) ⭐ 11,033 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-22 - The Browser Exploitation Framework Project by [beefproject](https://beefproject.com).
* [xssor2](https://github.com/evilcos/xssor2) ⭐ 2,219 | 🐛 4 | 🌐 JavaScript | 📅 2021-12-12 - XSS'OR - Hack with JavaScript by [@evilcos](https://github.com/evilcos).
...
* [sqlmap](https://github.com/sqlmapproject/sqlmap) ⭐ 38,523 | 🐛 31 | 🌐 Python | 📅 2026-09-25 - Automatic SQL injection and database takeover tool.

<a name="tools-template-injection"></a>

#### Template Injection

* [tplmap](https://github.com/epinna/tplmap) ⭐ 4,206 | 🐛 46 | 🌐 Python | 📅 2024-04-21 - Code and Server-Side Template Injection Detection and Exploitation Tool by [@epinna](https://github.com/epinna).
...
* [XSRFProbe](https://github.com/0xInfection/XSRFProbe) ⭐ 1,307 | 🐛 0 | 🌐 Python | 📅 2026-07-12 - The Prime CSRF Audit & Exploitation Toolkit by [@0xInfection](https://github.com/0xinfection).
...
* [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,493 | 🐛 484 | 🌐 Go | 📅 2026-09-23 - Searches full repo history for secrets and keys by [@zricethezav](https://github.com/zricethezav).
* [LinkFinder](https://github.com/GerbenJavado/LinkFinder) ⭐ 4,450 | 🐛 53 | 🌐 Python | 📅 2024-04-13 - Python script that finds endpoints in JavaScript files by [@GerbenJavado](https://github.com/GerbenJavado).
...
* [HTTPLeaks](https://github.com/cure53/HTTPLeaks) ⭐ 2,123 | 🐛 0 | 🌐 HTML | 📅 2026-09-09 - All possible ways, a website can leak HTTP requests by [@cure53](https://github.com/cure53).
...
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,180 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-21 - Scanner detecting the use of JavaScript libraries with known vulnerabilities by [@RetireJS](https://github.com/RetireJS).
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,414 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-26 - DOM-only, super-fast, uber-tolerant XSS sanitizer for HTML, MathML and SVG by [Cure53](https://cure53.de/).
...
* [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 215 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-25 - Self-hosted CAPTCHA with behavioral analysis, vision-AI agent detection, headless-browser fingerprinting, and SHA-256 proof-of-work, maintained by [WebDecoy](https://github.com/WebDecoy).
...
* [WebDecoy](https://github.com/WebDecoy/wordpress-plugin) ⭐ 1 | 🐛 3 | 🌐 PHP | 📅 2026-09-25 - Zero-configuration WordPress bot-detection plugin combining WebDriver detection, headless-browser fingerprinting, behavioral analysis, and SHA-256 proof-of-work, maintained by [WebDecoy](https://github.com/WebDecoy).
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,156 | 🐛 496 | 🌐 Python | 📅 2026-09-10 - Interactive TLS-capable intercepting HTTP proxy for penetration testers and software developers by [@mitmproxy](https://github.com/mitmproxy).
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,074 | 🐛 1 | 🌐 Rust | 📅 2026-09-25 - Single-binary intercepting proxy for HTTP, HTTPS, and WebSocket traffic that pauses and edits requests in flight, replays them, rewrites traffic with Lua hooks, and exports captures as HAR, curl, or raw HTTP, available as a terminal UI, web GUI, or headless REST API, by [@emanuele-em](https://github.com/emanuele-em).
...
* [webshell](https://github.com/tennc/webshell) ⭐ 10,784 | 🐛 0 | 🌐 PHP | 📅 2024-12-24 - This is a webshell open source project by [@tennc](https://github.com/tennc).
...
* [PhpSploit](https://github.com/nil0x42/phpsploit) ⭐ 2,492 | 🐛 27 | 🌐 Python | 📅 2024-05-06 - Full-featured C2 framework which silently persists on webserver via evil PHP oneliner by [@nil0x42](https://github.com/nil0x42).
...
* [radare2](https://github.com/radare/radare2) ⭐ 24,876 | 🐛 813 | 🌐 C | 📅 2026-09-26 - Unix-like reverse engineering framework and commandline tools by [@radare](https://github.com/radare).
...
* [CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,960 | 🐛 582 | 🌐 JavaScript | 📅 2026-09-26 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis - by [@GCHQ](https://github.com/gchq).
...
* [cefdebug](https://github.com/taviso/cefdebug) ⭐ 208 | 🐛 0 | 🌐 C | 📅 2020-06-10 - Minimal code to connect to a CEF debugger by [@taviso](https://github.com/taviso).
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,951 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-26 - Probably the most modern and sophisticated insecure web application - Written by [@bkimminich](https://github.com/bkimminich) and the [@owasp\_juiceshop](https://twitter.com/owasp_juiceshop) team.
...
* [OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 46 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-24 - Intentionally vulnerable e-commerce application built with Next.js - Written by [@kOaDT](https://github.com/kOaDT).
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,737 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - Rhino Security Labs' "Vulnerable by Design" AWS infrastructure setup tool  - Written by [@RhinoSecurityLabs](https://github.com/RhinoSecurityLabs).
...
* [Infosec\_Reference](https://github.com/rmusser01/Infosec_Reference) ⭐ 5,996 | 🐛 4 | 🌐 CSS | 📅 2025-10-20 - Information Security Reference That Doesn't Suck by [@rmusser01](https://github.com/rmusser01).
* [awesome-bug-bounty](https://github.com/djadmin/awesome-bug-bounty) ⭐ 5,912 | 🐛 31 | 📅 2026-03-07 - Comprehensive curated list of available Bug Bounty & Disclosure Programs and write-ups by [@djadmin](https://github.com/djadmin).
* [bug-bounty-reference](https://github.com/ngalongc/bug-bounty-reference) ⭐ 4,270 | 🐛 3 | 📅 2024-07-31 - List of bug bounty write-up that is categorized by the bug nature by [@ngalongc](https://github.com/ngalongc).
* [EQGRP](https://github.com/x0rz/EQGRP) ⭐ 4,203 | 🐛 18 | 🌐 Perl | 📅 2017-05-24 - Decrypted content of eqgrp-auction-file.tar.xz by [@x0rz](https://github.com/x0rz).
* [notes](https://github.com/ChALkeR/notes) ⭐ 1,276 | 🐛 1 | 📅 2019-07-13 - Some public notes by [@ChALkeR](https://github.com/ChALkeR).
* [htb-writeups](https://github.com/momenbasel/htb-writeups) ⭐ 262 | 🐛 0 | 🌐 HTML | 📅 2026-07-18 - Comprehensive Hack The Box writeup collection covering 75+ web challenges including XSS, SQLi, SSTI, SSRF, and deserialization, by [@momenbasel](https://github.com/momenbasel).
